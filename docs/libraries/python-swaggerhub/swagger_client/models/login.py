...
class Login(object):
    ...
    def __init__(self, code=None, scopes=None):  # noqa: E501
    ...
    @property
    def scopes(self):
        """Gets the scopes of this Login.  # noqa: E501


        :return: The scopes of this Login.  # noqa: E501
        :rtype: list[str]
        """
        return self._scopes
    ...
    def scopes(self, scopes):
        """Sets the scopes of this Login.


        :param scopes: The scopes of this Login.  # noqa: E501
        :type: list[str]
        """
        if scopes is None:
